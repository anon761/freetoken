...
def _build_parser(prog: str) -> argparse.ArgumentParser:
    ...
    generate.add_argument("--max-tokens", type=int, default=16, help="Tokens to generate (default 16)")
    generate.add_argument("--ignore-eos", action="store_true", help="Do not stop at the EOS token")
    ...
    requests.add_argument("--since", type=int, default=0, help="Only requests with id > N")
    requests.add_argument("--limit", type=int, default=100, help="Max entries to print (default 100)")
    return parser
