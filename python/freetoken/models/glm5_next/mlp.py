...
from freetoken.layers.linear import LinearColParallelMerged, LinearRowParallel
...
class Glm5NextGatedMLP(BaseOP):
    def __init__(
        ...
        *,
        ...
        # TP: gate/up column-parallel (local intermediate slice), down row-parallel
        # with all_reduce. At TP=1 both resolve to the replicated linears as before.
        # The local intermediate is exactly div_even(intermediate, tp).
