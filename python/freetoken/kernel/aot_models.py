...
SUPPORTED_MODELS: tuple[AotModel, ...] = (
    ...
    AotModel(
        ...
        # language-model-only exports declare the text tower's own architecture
    ...
    # DeepSeek-V4.1-Flash: Phase 1 skeleton serves generic full attention
    # (kv_groups match the placeholder FULL group; Phase 3's CSA2 topology
    # updates this entry) with MXFP4 routed experts on the offload cache.
    AotModel(
