...
class TritonMxfp4MoEKernel(MoEKernel):
    ...
    def layout(self, cfg: MoEConfig) -> dict[str, BankSpec]:
        # TP: the banks carry this rank's intermediate slice (mirrors the nvfp4
        # triton kernel — the offload layer all_reduces the partial down outputs;
        # at TP=1 local_intermediate == intermediate, banks unchanged).
