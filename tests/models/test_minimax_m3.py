    ...
    return _Cfg(
        {
            ...
            # modelopt MIXED_PRECISION: the per-module map names the experts (NVFP4) and the
            # dense projections (MXFP8). The reader resolves both through the dialect layer.
            "quantization_config": {
                "quant_algo": "MIXED_PRECISION",
                "quant_method": "modelopt",
                "quantized_layers": {
                    "language_model.model.layers.3.block_sparse_moe.experts.0.w1": {"quant_algo": "NVFP4"},
                    "language_model.model.layers.3.block_sparse_moe.experts.0.w2": {"quant_algo": "NVFP4"},
                    "language_model.model.layers.3.block_sparse_moe.experts.0.w3": {"quant_algo": "NVFP4"},
                    "language_model.model.layers.0.mlp.gate_proj": {"quant_algo": "MXFP8"},
                    "language_model.model.layers.0.mlp.up_proj": {"quant_algo": "MXFP8"},
                    "language_model.model.layers.0.mlp.down_proj": {"quant_algo": "MXFP8"},
                },
            },
            "text_config": {
                "hidden_size": 6144,
